setTimeout(() => {
  ...
  function create() {
    // Set initial time, ensure spinning is false,  set up game physics engine
    time = moment();
    spinning = false;
    game.physics.startSystem(Phaser.Physics.ARCADE);

    // Initialize fidget spinner sprite
